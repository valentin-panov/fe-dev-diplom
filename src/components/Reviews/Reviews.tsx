  ...
  return (
    <div className={cn(s.root, className)} id="reviews">
      ...
      <div className={s.slidesBlock}>
        <Carousel slidesToShow={2} afterChange={onChange} autoplay>
          <div>
            ...
            <div className={s.reviewCard}>
              ...
              <div className={s.review}>
                ...
                <div className={s.review__text}>
                  <span>
                    <img src={openQ} alt="open quota" className={s.openQ} />
                    СМС-сопровождение до посадки Сразу после оплаты ж/д билетов и за 3 часа до отправления мы пришлем
                    вам СМС-напоминание о поездке. <img src={closeQ} alt="open quota" className={s.closeQ} />
                  </span>
                </div>
              </div>
            </div>
